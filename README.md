...
Fork the following repo `https://github.com/open-sudo/backstage-demo` to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/open-sudo/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/open-sudo/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/cluster-dczvv.dczvv.sandbox1816.opentlc.com/${base_domain}/g" {} +
git add -A
...
Fork the following repo `https://github.com/open-sudo/shared-workflows` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/open-sudo/software-templates` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/open-sudo/backstage-app-demo` to your organization.
